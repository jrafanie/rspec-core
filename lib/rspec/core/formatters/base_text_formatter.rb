    ...
    module Formatters
      ...
      class BaseTextFormatter < BaseFormatter
        ...
        def dump_profile
          ...
          dump_profile_slowest_example_groups_by_total_time
        end
        ...
        def profile_example_groups
          @profiled_example_groups ||= begin
            example_groups = {}
            ...
            return example_groups if example_groups.keys.length <= 1
        ...
        def dump_profile_slowest_example_groups_by_total_time
          example_groups = profile_example_groups
          number_of_examples = RSpec.configuration.profile_examples

          sorted_groups = example_groups.sort_by {|_, hash| -hash[:total_time]}.first(number_of_examples)

          output.puts "\nTop #{sorted_groups.size} slowest example groups (by total time):"
